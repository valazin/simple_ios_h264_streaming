...
void sender_disconnect(sender_t *sender, const char* stream_id);

void sender_send_frame(sender_t *sender, const char* stream_id, char* buffer, long buffer_size, FrameContext frameContext);
